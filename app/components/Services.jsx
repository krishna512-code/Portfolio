    ...
    return (
        <motion.div initial={{ opacity: 0 }}
            ...
            <motion.p initial={{ opacity: 0 }}
                ...
                I am a full stack developer from India, offering end-to-end web and application development services.
            </motion.p>
            <motion.div initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ duration: 0.6, delay: 0.9 }} className='grid grid-cols-auto gap-6 my-20'>
