  ...
  return (
    ...
    >
      <motion.h4 initial={{ opacity: 0, y: -20 }}
        ...
        transition={{ duration: 0.5, delay: 0.3 }} className="text-center mb-2 text-lg font-Ovo">Introduction</motion.h4>
      <motion.h2 initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.5 }} className="text-center text-5xl font-Ovo">About Me</motion.h2>
      <motion.div initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        transition={{ duration: 0.8 }} className="flex w-full flex-col lg:flex-row items center gap-20 my-10 ">
        <motion.div
          initial={{ opacity: 0, scale: 0.9 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.6 }} className="w-70 sm:w-80 rounded-3xl max-w-none">
          <Image
        ...
        <motion.div initial={{ opacity: 0 }}
          ...
          <p className="mb-10 max-w-2xl font-Ovo">
            I am an experienced FullStack Web Developer with over a decade of hands-on experience building scalable, high-performance web applications. My expertise spans both frontend and backend technologies, allowing me to deliver seamless user experiences and robust server-side solutions. I am passionate about learning new technologies, solving complex problems, and collaborating with teams to create impactful digital products.
          </p>
          ...
          <motion.h4 initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 1.3 }} className="my-6 text-gray-700 font-Ovo dark:text-white/80">Tools I use</motion.h4>
          <motion.ul initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
